...
releases=$( git ls-remote -q --tags git@github.com:meteor/meteor.git release/METEOR@* | grep -o -P '(?<=METEOR@)1\.([5-9]|\d\d+)(\.\d+)*' | sort | uniq )
repo="empiricaly/meteor"

echo "Meteor releases available: ${releases[@]}"

releasesToSkip=( "1.5.4.2" "1.6.1.2" "1.6.1.3" "1.6.2" "1.7.1" "1.10" )
